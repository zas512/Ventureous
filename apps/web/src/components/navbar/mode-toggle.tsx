  ...
  return (
    <motion.div animate={isDark ? "checked" : "unchecked"}>
      ...
      >
        ...
        />
        {/* Sun rays */}
        <motion.path d="M12.4058 1.76251V3.76251" {...sunProps} />
        <motion.path d="M12.4058 21.7625V23.7625" {...sunProps} />
        <motion.path d="M4.62598 4.98248L6.04598 6.40248" {...sunProps} />
        <motion.path d="M18.7656 19.1225L20.1856 20.5425" {...sunProps} />
        <motion.path d="M1.40576 12.7625H3.40576" {...sunProps} />
        <motion.path d="M21.4058 12.7625H23.4058" {...sunProps} />
        <motion.path d="M4.62598 20.5425L6.04598 19.1225" {...sunProps} />
        <motion.path d="M18.7656 6.40248L20.1856 4.98248" {...sunProps} />
        {/* Moon */}
        <motion.path
